 ...
 * @author davidroussel
 */
public class PolygonShapeCreationTool extends AbstractCreationTool
{
	/**
	 ...
	 */
	protected PolygonShapeCreationTool(Pane root,
	                                       Drawing model,
	                                       Label label,
	                                       int steps,
	                                       int eventsMask,
	 ...
	 * tool (will also creates the required number of {@link AbstractMultiStepDrawingTool#tips})
	 */
	public PolygonShapeCreationTool(Pane root,
	                                    Drawing model,
	                                    Label label,
	                                    HistoryManager<Figure> manager,
	                                    Logger parentLogger)
